...
VAR
  ...
  CounterOfReadChars, PositionsCounter, Count, PositionsString: INTEGER; 
...
BEGIN
  CASE Ch OF
    'A': ChooseMatrix := [3, 7, 9, 11, 15, 16, 17, 18, 19, 20, 21, 25]; 
    ...
    'N': ChooseMatrix := [1, 5, 6, 7, 9, 10, 11, 13, 14, 16, 18, 19, 21, 22, 25];
            ...
            BEGIN
              ...
              DO
                BEGIN
                  ...
                  THEN
                    PositionsSet := PositionsSet + [PositionsCounter - (5 * PositionsString) + 5 * (CounterOfReadChars - 1) + (CounterOfReadChars - 1) + (50 * PositionsString)];
                END
            END   
        END
    END;
