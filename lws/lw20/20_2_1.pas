...
BEGIN
    ...
    BEGIN 
      ...
      THEN
        BEGIN
          ...
          FOR PositionsCounter := 1 TO 5
          DO
            BEGIN
              IF PositionsCounter IN Matrix
              THEN
                PositionsSet := PositionsSet + [PositionsCounter + 5 * (CounterOfReadChars - 1) + (CounterOfReadChars - 1)]
            END;
        END
      ELSE
  ...
  DO
    BEGIN
      IF PositionsCounter IN PositionsSet
      THEN
        WRITE('#')
      ELSE
        WRITE(' ');
      IF PositionsCounter MOD 60 = 0
      THEN
        WRITELN
    END 
  {Тест}
